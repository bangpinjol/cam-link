#!/bin/bash
# linkhack v1.5
# Powered by Tools Pinjol
# Credits goes to thelinuxchoice [https://github.com/bangpinjol/cam-link.git]
...
printf " \e[1;93m linkcam Ver 1.5 \e[0m \n"
printf " \e[1;77m www.toolspinjonterbaru.org | youtube.com/@toolspinjol \e[0m \n"
